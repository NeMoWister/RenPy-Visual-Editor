"""
Генератор кода screen language Ren'Py из модели core/screen_model.py.

generate_screen(screen)      -> код одного `screen name(...):` блока
generate_document(document)  -> код всех экранов подряд (для экспорта в
                                 screens.rpy), разделённых пустой строкой
"""
