"""
Визуализация дерева коммитов (граф веток) - рисует дорожки (lanes) и точки
коммитов слева, текст (хэш/сообщение/автор/дата/бейджи веток-тегов) справа.
Дорожки уже посчитаны в core.git_manager.get_log_graph (_assign_lanes).
"""
