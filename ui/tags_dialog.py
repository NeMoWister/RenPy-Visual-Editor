...
"""
Диалог управления категориями тегов (для фонов/CG): слева - категории
("Локация", "Время суток", ...), справа - теги внутри выбранной категории
("пляж", "лес", "город" - для категории "Локация").

Изменения применяются в TagsStore сразу и сохраняются на диск при каждом
действии (как и переопределения ресурсов) - отдельной кнопки "Сохранить"
не требуется.
"""
